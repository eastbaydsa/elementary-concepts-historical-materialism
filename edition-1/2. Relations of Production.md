...
On the basis of what we have seen we can affirm that the type of relationship
...
This right of ownership can arise from a simple collective consent motivated
by political or ideological reasons, or can take on finished juridical
forms. Moreover its content varies according to the different historical
...
that is to say, on the exploited peasants."
...
The revolution in which the means of labor lead to a revolution in t~e general
...
Social relations of production cannot be considered solely as human relations,
relations between human beings. They are relations between agents
...
and the direct producers*. This relation between human beings passes,
therefore, through a relation with objects: the means of production.

This point is of great importance, since it destroys all the utopian
ideas about "collaboration between workers and bosses". The relations between
workers and bosses cannot be "fraternal" as long as their relations with the
...
[^2.4]: We speak of possession when there exists the simple detention of a good
