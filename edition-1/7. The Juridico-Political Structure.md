...
One of the distinctive features of every State is the existence
...
fundamental reforms of the structure and to the new role
...
emphasis on the socialization of the productive forces: if
...
that of the economic base, 2) that of the ideological
superstructure.

l. *The weakness at the level of the base* has its
    ...
    economic base, is to resolve this contradiction.
...
2. *Weakness on the level of the ideological superstructure*.
    ...
    make a revolution on the ideological level. And in order for
...
essence of the dictatorship of the proletariat starting with
the tasks that arise to eliminate these two kinds of
weaknesses:
...
Thus, since the proletariat is
faced with a fierce opposition from the bourgeoisie in completing these tasks, the
...
political and economic power do not always coincide.
...
1. How do you analyze, from a Marxist viewpoint, the
